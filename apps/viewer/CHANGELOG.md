...
- [#5959](https://github.com/LTplus-AG/ifc-lite/pull/5959) [`59c67d0`](https://github.com/LTplus-AG/ifc-lite/commit/59c67d09bf6ca2f22366e45bd02d23e5763aacea) Thanks [@louistrue](https://github.com/louistrue)! - A **Settings** dialog is the viewer's one home for preferences. It opens from the ribbon's View tab (new Settings button), the classic toolbar's View options menu, and the command palette ("Settings…"). **General** holds theme, toolbar style and hover tooltips; **Display** holds Navigation → SpaceMouse, which moved here from the Info dialog's Preferences tab. The Info dialog no longer has a Preferences tab, and every SpaceMouse button now opens Settings → Display.
...
- [#6082](https://github.com/LTplus-AG/ifc-lite/pull/6082) [`1e9f615`](https://github.com/LTplus-AG/ifc-lite/commit/1e9f615f7863c9ada440bdb273f5509eea91eabf) Thanks [@louistrue](https://github.com/louistrue)! - Closing the Clash panel now releases only the isolation or X-ray it set itself, so an isolation made elsewhere survives. Closing the BCF panel gives back the section cut (and tool) that viewpoints replaced, unless you changed the cut meanwhile.

- [#5939](https://github.com/LTplus-AG/ifc-lite/pull/5939) [`573343d`](https://github.com/LTplus-AG/ifc-lite/commit/573343db84fa86d786ed4a4c3b9aeea19bb5c021) Thanks [@louistrue](https://github.com/louistrue)! - The Bulk property editor's class targets now select exact IFC classes ([#5864](https://github.com/LTplus-AG/ifc-lite/issues/5864)).
...
- [#6099](https://github.com/LTplus-AG/ifc-lite/pull/6099) [`c126a23`](https://github.com/LTplus-AG/ifc-lite/commit/c126a23f1a6b00d1d5a4012169f5a0a7d39014c0) Thanks [@louistrue](https://github.com/louistrue)! - Move privacy controls into Settings and add a persistent product-analytics opt-out.

- [#5929](https://github.com/LTplus-AG/ifc-lite/pull/5929) [`a812b9f`](https://github.com/LTplus-AG/ifc-lite/commit/a812b9f04d807be9a014317870019959e22a94fe) Thanks [@louistrue](https://github.com/louistrue)! - Clash panel: Re-run now repeats the run that produced the result on screen (Detect all, the rule set, one preset, or the duplicate scan) instead of always running "Detect all", and its tooltip names what it will repeat.

- [#6079](https://github.com/LTplus-AG/ifc-lite/pull/6079) [`4528afa`](https://github.com/LTplus-AG/ifc-lite/commit/4528afa45fd91c40115957a7c09670c7c24561f6) Thanks [@louistrue](https://github.com/louistrue)! - "Add Classification" and "Add Material" now create real IFC entities ([#5876](https://github.com/LTplus-AG/ifc-lite/issues/5876)).
  ...
  - text that would be written as a STEP token (`$`, `[#12](https://github.com/LTplus-AG/ifc-lite/issues/12)`, `.ENUM.`).

- [#6131](https://github.com/LTplus-AG/ifc-lite/pull/6131) [`8f83154`](https://github.com/LTplus-AG/ifc-lite/commit/8f83154af3add7f2b036bcfc3929a7203b42c323) Thanks [@louistrue](https://github.com/louistrue)! - Show every active visibility reason as a count-only viewport chip. Clear individual resettable reasons from their chips, explain kept settings, and offer one registry-driven reset when several reasons are active.
...
- [#6096](https://github.com/LTplus-AG/ifc-lite/pull/6096) [`b47303f`](https://github.com/LTplus-AG/ifc-lite/commit/b47303f464bcfd628b73ddf617d90f96536a0eb7) Thanks [@louistrue](https://github.com/louistrue)! - Make IDS, Clash, and Compare analysis runs cancellable without losing prior results.

- [#6127](https://github.com/LTplus-AG/ifc-lite/pull/6127) [`6d1833f`](https://github.com/LTplus-AG/ifc-lite/commit/6d1833f2303ec9eba13abf4f33e7588b01f45eb4) Thanks [@louistrue](https://github.com/louistrue)! - Explain which visible drawing markups and underlays a PDF or DXF export leaves out before downloading it.

- [#6029](https://github.com/LTplus-AG/ifc-lite/pull/6029) [`1ba1561`](https://github.com/LTplus-AG/ifc-lite/commit/1ba156121872ae513bd1fdd9526a93697af4763c) Thanks [@louistrue](https://github.com/louistrue)! - Fit All now frames what is visible ([#5884](https://github.com/LTplus-AG/ifc-lite/issues/5884)). It used to frame every mesh ever loaded, including hidden elements, geometry outside the current isolation, storey or class filter, and every model toggled invisible, so isolating one storey and pressing Fit All still framed the whole building. It now frames the visible elements where they are (a moved model included), still leaving a stray far-away element out of the frame as the load-time fit does. The toolbar button, the Z shortcut, F with nothing selected and the SpaceMouse fit button all use this one Fit All. Home still frames the whole project.

- [#6106](https://github.com/LTplus-AG/ifc-lite/pull/6106) [`79a0c32`](https://github.com/LTplus-AG/ifc-lite/commit/79a0c329ec713a69d1d8db1ef784df1544ed7025) Thanks [@louistrue](https://github.com/louistrue)! - Add persisted navigation presets with trackpad two-finger pan and configurable pointer gestures.

- [#6105](https://github.com/LTplus-AG/ifc-lite/pull/6105) [`e99c71a`](https://github.com/LTplus-AG/ifc-lite/commit/e99c71a870730efc646bb55f21f3ae90f04915d4) Thanks [@louistrue](https://github.com/louistrue)! - Use one pointer gesture mapping across viewer tools so Shift + left drag pans in Measure as well as Select.

- [#6074](https://github.com/LTplus-AG/ifc-lite/pull/6074) [`44fcaef`](https://github.com/LTplus-AG/ifc-lite/commit/44fcaef5f247c70fd1932ed24138b174f71535f7) Thanks [@louistrue](https://github.com/louistrue)! - "Hide selection" now behaves the same on every surface. Del, Backspace and
...
- [#6071](https://github.com/LTplus-AG/ifc-lite/pull/6071) [`f7767fc`](https://github.com/LTplus-AG/ifc-lite/commit/f7767fc5311acbff3a5ab053d674a5fa8caaee78) Thanks [@louistrue](https://github.com/louistrue)! - Icon-only buttons now have accessible names and keyboard-visible tooltips ([#5811](https://github.com/LTplus-AG/ifc-lite/issues/5811)). A new `IconButton` primitive requires a label, sets it as the button's `aria-label`, and shows it as a tooltip on hover and on keyboard focus. 148 icon buttons across the Properties, Property editor, AI chat, Script, IDS, Lists, BCF, Zones, Schedule, Clash, Extensions and other panels now use it. Among them are buttons a screen reader previously announced only as "button": close AI chat, scroll to latest message, copy GlobalId, save attribute, remove mapping, close location zones, and remove title-block field or revision. Buttons that were named only by `title=` now show their tooltip on focus as well.

- [#6080](https://github.com/LTplus-AG/ifc-lite/pull/6080) [`685d4f5`](https://github.com/LTplus-AG/ifc-lite/commit/685d4f5c6eb937ab32a740513ead8eb4673ba1bb) Thanks [@louistrue](https://github.com/louistrue)! - IDS → BCF export: the dialog now defaults to one topic per failing specification, shows how many topics the chosen grouping creates, and warns before an export would pass the 1,000-topic cap. Snapshot capture stops at the cap instead of rendering every failing entity.

- [#6041](https://github.com/LTplus-AG/ifc-lite/pull/6041) [`5542617`](https://github.com/LTplus-AG/ifc-lite/commit/5542617b64aa0c1bfc8b113332d0ce2f7f40415c) Thanks [@louistrue](https://github.com/louistrue)! - Adding a property to a property set that an element only inherits from its type no longer creates a one-property set of that name on the element ([#5966](https://github.com/LTplus-AG/ifc-lite/issues/5966)). The new occurrence set carries a copy of the type set's current values forward (value type and IFC data type kept), and the type's own set is left unchanged, so tools that let an occurrence set replace the type's set of the same name no longer show the other properties as lost. The Add property dialog says so when the chosen set is inherited, and the bSDD card follows the same rule. Each value reaches collaboration peers, and one Ctrl+Z removes the override. When the inherited set holds a property that cannot be copied exactly (multi-valued, or with its own unit), nothing is added and the message says why. IFC2X3 door and window styles are now read as type objects, so their sets are found too.
...
- [#5976](https://github.com/LTplus-AG/ifc-lite/pull/5976) [`27c9237`](https://github.com/LTplus-AG/ifc-lite/commit/27c92374a0044624e0f679045eb246ba0174eb13) Thanks [@louistrue](https://github.com/louistrue)! - Mobile: the zoom buttons' tooltips no longer name the + and − keys, which add to and remove from the basket rather than zoom. The tooltips now read "Zoom in" and "Zoom out" ([#5846](https://github.com/LTplus-AG/ifc-lite/issues/5846)).

- [#6115](https://github.com/LTplus-AG/ifc-lite/pull/6115) [`b4a125a`](https://github.com/LTplus-AG/ifc-lite/commit/b4a125ad1a84f25037020f8b0bca3b3151ea5b5a) Thanks [@louistrue](https://github.com/louistrue)! - Show the projected camera pivot while orbiting the web viewer.
...
- [#5938](https://github.com/LTplus-AG/ifc-lite/pull/5938) [`b98b585`](https://github.com/LTplus-AG/ifc-lite/commit/b98b5859fe93ee7dcae42aa4ecbcbf4d2c61d370) Thanks [@louistrue](https://github.com/louistrue)! - An active lens keeps working after its panel closes. Lens evaluation and its hides now run from a host that is mounted for the viewer's lifetime, not from the Lens panel. A model federated in or edited while the panel is closed is now coloured and hidden by the lens too. Every Show all / Home control in the viewer (toolbar, ribbon, context menu, mobile toolbar, `A` key, command palette) keeps the active lens's hides, the same way it already kept the lens's colours, and removes only the user's own hides. The scripting and embed `reset()` still calls the slice-level `showAllInAllModels` and is unchanged.

- [#6077](https://github.com/LTplus-AG/ifc-lite/pull/6077) [`1053c12`](https://github.com/LTplus-AG/ifc-lite/commit/1053c1289625a71823caa4bcf06be18b38ca26f0) Thanks [@louistrue](https://github.com/louistrue)! - Show All, Home, the `A` key and the context menu's Show all now run one reset, driven by a single table of every mechanism that can hide geometry. Hidden federated models now come back too; before, every reset left them hidden. The active lens, the class-type toggles, the Model/Types view mode and embed-host hidden classes are deliberately kept, and the table names them so the viewport can say so.

- [#5918](https://github.com/LTplus-AG/ifc-lite/pull/5918) [`7ce2011`](https://github.com/LTplus-AG/ifc-lite/commit/7ce201186d519c56390a211ef10d729b77ead10e) Thanks [@louistrue](https://github.com/louistrue)! - Export labels now say what the export contains ([#5835](https://github.com/LTplus-AG/ifc-lite/issues/5835)). "Export JSON (All Data)" is "Export JSON (active model)", since it only ever exported the active model. The toolbar's "Export Changes", which exports whole IFC files with the edits applied, is "Export modified IFC…". The IFC dialog's "Changes Only" toggle is "Changes only (JSON delta)", or "Changes only (IFCX overlay)" for an IFC5 model, so it no longer reads like the toolbar button.

- [#6070](https://github.com/LTplus-AG/ifc-lite/pull/6070) [`47ff0e2`](https://github.com/LTplus-AG/ifc-lite/commit/47ff0e2de37f6c42da75c31a53881d97c8cd8793) Thanks [@louistrue](https://github.com/louistrue)! - Extension exporters and "Export modified IFC…" are now entries of the export registry, so every export surface reaches them ([#5838](https://github.com/LTplus-AG/ifc-lite/issues/5838)). An installed extension exporter used to appear only as a block inside the Export IFC dialog; it is now a row in the classic Export menu (under "From extensions"), a button in the ribbon's Export group, and a command palette row, and its file is named after the active model. "Export modified IFC…" was only the amber toolbar button; it is now also in the Export menu, the ribbon and the palette (disabled until a model has unexported edits), and every entry opens the same review dialog.

- [#6085](https://github.com/LTplus-AG/ifc-lite/pull/6085) [`c388cf6`](https://github.com/LTplus-AG/ifc-lite/commit/c388cf67218a0e1bc97d0adabf538b5df1831d28) Thanks [@louistrue](https://github.com/louistrue)! - Make every IDS entity result reachable through a virtualized specification list.

- [#6102](https://github.com/LTplus-AG/ifc-lite/pull/6102) [`33d9a53`](https://github.com/LTplus-AG/ifc-lite/commit/33d9a5395ff7e6a568a652b0d542a760a0e5e530) Thanks [@louistrue](https://github.com/louistrue)! - Keep IDS, Clash, and Compare reports visible with a shared stale-result banner after model edits or geometry changes.

- [#5967](https://github.com/LTplus-AG/ifc-lite/pull/5967) [`6dccd1f`](https://github.com/LTplus-AG/ifc-lite/commit/6dccd1f9b405faa742ac923771355f98b2378b2f) Thanks [@louistrue](https://github.com/louistrue)! - The "SHORTCUTS ?" chip under the empty viewer's welcome card is now a real button that opens the keyboard shortcuts. It used to look clickable and do nothing.

- [#6094](https://github.com/LTplus-AG/ifc-lite/pull/6094) [`b7035a8`](https://github.com/LTplus-AG/ifc-lite/commit/b7035a8969134c1feeb7948e21528104eaecbeab) Thanks [@louistrue](https://github.com/louistrue)! - Add a persistent Display setting for performance stats and keep the FPS sampler idle while it is off.

- [#6092](https://github.com/LTplus-AG/ifc-lite/pull/6092) [`44b0777`](https://github.com/LTplus-AG/ifc-lite/commit/44b0777e1543af52411bf8c9c312147caaf63778) Thanks [@louistrue](https://github.com/louistrue)! - Let collaborators set a persistent display name in Viewer Settings.

- [#6009](https://github.com/LTplus-AG/ifc-lite/pull/6009) [`584d58b`](https://github.com/LTplus-AG/ifc-lite/commit/584d58b654b10c012beae9fc1f0997e4317b010b) Thanks [@louistrue](https://github.com/louistrue)! - The toolbar zoom-in and the SpaceMouse dolly now stop short of the surface at the centre of the viewport instead of passing through thin objects ([#5924](https://github.com/LTplus-AG/ifc-lite/issues/5924)), as the wheel ([#5393](https://github.com/LTplus-AG/ifc-lite/issues/5393)) and touch pinch ([#5547](https://github.com/LTplus-AG/ifc-lite/issues/5547)) already do. They go through the same gated surface pick, so there is no raycast while a model is streaming, above the orbit-pivot census limit, or with a robust orbit anchor. Zoom-out is unchanged.

- [#6081](https://github.com/LTplus-AG/ifc-lite/pull/6081) [`71a3256`](https://github.com/LTplus-AG/ifc-lite/commit/71a32564589f6198058a2107e29ad33615d7e1fe) Thanks [@louistrue](https://github.com/louistrue)! - Touch: a finger is handled by the touch controls only. The mouse controls used to process touch-sourced pointer events as well, so a one-finger drag was orbited twice, and the Measure tool could not place a point by tap in any mode. Measure now works by tap: two taps measure a distance in Drag mode, and a tap places a point in the polyline, angle and radius modes ([#5856](https://github.com/LTplus-AG/ifc-lite/issues/5856)).

- [#5999](https://github.com/LTplus-AG/ifc-lite/pull/5999) [`80aa532`](https://github.com/LTplus-AG/ifc-lite/commit/80aa532365c742ddf0cf6129e06e57b64b349f8b) Thanks [@louistrue](https://github.com/louistrue)! - Touch pinch zoom now follows the mobile convention: spreading two fingers zooms in and pinching them together zooms out ([#5777](https://github.com/LTplus-AG/ifc-lite/issues/5777)). It was the reverse, because the pinch fed `Camera.zoom` a positive delta (zoom out) when the fingers spread. A zoom-in pinch still stops short of the surface under the pinch ([#5547](https://github.com/LTplus-AG/ifc-lite/issues/5547)).

- [#5680](https://github.com/LTplus-AG/ifc-lite/pull/5680) [`96f0b50`](https://github.com/LTplus-AG/ifc-lite/commit/96f0b507371f0a2feda147122ecccec5725523cf) Thanks [@louistrue](https://github.com/louistrue)! - The hosted viewer's anonymous product analytics now record which UI surface was used, so the UX refactor can be measured ([#5618](https://github.com/LTplus-AG/ifc-lite/issues/5618)): command-palette commands, panel opens (from the ribbon, classic toolbar, sidebar rail, palette or a shortcut) and replacements, tool activation and exit, view resets (Home, A, Show all), load errors shown, rejected file opens and onboarding dismissals. Panels and tools the app opens by itself (tours, loads, drawings) are not counted. Each event carries fixed ids only, and the `before_send` scrubber drops any other property, any person-property update, and any value outside the event's vocabulary. Autocapture stays off. Picking an unsupported file through the Open button now explains why, as dropping one already did.
...
- [#6078](https://github.com/LTplus-AG/ifc-lite/pull/6078) [`0f7bd58`](https://github.com/LTplus-AG/ifc-lite/commit/0f7bd58cdb9df54d8f338597cf000d93fc837560) Thanks [@louistrue](https://github.com/louistrue)! - While a model loads, the viewport now shows a loading card with the file name, the current phase and a percentage, and a **Cancel** button. Cancelling a model load stops it and returns the viewer to its empty state, with no error; the status bar's Cancel (which used to cover only point-cloud streams) now cancels model loads too. The ribbon, classic and mobile toolbars read their load progress from the same selector as the card.

- [#6087](https://github.com/LTplus-AG/ifc-lite/pull/6087) [`ad3be45`](https://github.com/LTplus-AG/ifc-lite/commit/ad3be45d101501dd8059b3aa5dcc01d72d067781) Thanks [@louistrue](https://github.com/louistrue)! - Hierarchy rows identify their source model consistently across grouping modes, and equal material names stay separate in federated models.

- [#6014](https://github.com/LTplus-AG/ifc-lite/pull/6014) [`8fc6ad3`](https://github.com/LTplus-AG/ifc-lite/commit/8fc6ad3897f48bcd5a1c61b1274ebc5afd0c71bf) Thanks [@louistrue](https://github.com/louistrue)! - Dropping a file anywhere in the viewer window now opens it, not only over the 3D view ([#5845](https://github.com/LTplus-AG/ifc-lite/issues/5845)). A file dropped on the toolbar, sidebar, status bar or a panel used to be ignored, and over some of that chrome the browser navigated away to the file. The drop overlay now covers the whole window. Panels with their own drop zones keep their drops, and text or link drags are left alone.
