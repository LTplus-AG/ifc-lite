...
type SemanticRecord = Exclude<LandXmlSourceRecord, { kind: 'surface' | 'point' | 'source-data-point' | 'face' | 'boundary' | 'breakline' | 'contour' | 'cogo-point' | 'monument' | 'plan-feature' | 'parcel' | 'plan-geometry' }>;
