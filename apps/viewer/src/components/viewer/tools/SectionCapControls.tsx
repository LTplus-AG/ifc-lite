    ...
    <div className="mt-3 border-t pt-3">
      ...
      {sectionPlane.showCap && (
        <div className="space-y-2">
          <div>
            <label className="text-[10px] text-muted-foreground block mb-1">Hatch pattern</label>
            <select
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              <label className="text-[10px] text-muted-foreground block mb-1">Fill</label>
              <input
                type="color"
            ...
            <div>
              <label className="text-[10px] text-muted-foreground block mb-1">Hatch</label>
              <input
                type="color"
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              <label className="text-[10px] text-muted-foreground block mb-1">Spacing (px)</label>
              <input
                type="number"
                min="2"
                max="64"
            ...
            <div>
              <label className="text-[10px] text-muted-foreground block mb-1">Angle (°)</label>
              <input
                type="number"
                min="-180"
                max="180"
