 ...
 *     top-left chips and the ViewCube;
...
import {
  ...
  Check, Minus, Building2, ChevronDown,
} from 'lucide-react';
...
import { OptionsPopover, HelpPopover, type OptionsPopoverProps } from './SpaceSketchPopovers';
...
export function SpaceSketchBar(p: SpaceSketchBarProps) {
  ...
  return (
    <HudToolbar className="select-none" data-tool-bar="spaceSketch">
