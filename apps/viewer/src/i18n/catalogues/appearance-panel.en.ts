...
export const appearancePanelEn = {
  ...
  'appearance.pdfFidelity.row.text': '{count} × Text runs',
  'appearance.pdfFidelity.row.textRegion': '{count} × Text runs — region x {x0}–{x1}, y {y0}–{y1} pt',
  'appearance.pdfFidelity.row.image': '{count} × Images',
  'appearance.pdfFidelity.row.imageRegion': '{count} × Images — region x {x0}–{x1}, y {y0}–{y1} pt',
  'appearance.pdfFidelity.row.clip': '{count} × Clipped content',
  'appearance.pdfFidelity.row.clipRegion': '{count} × Clipped content — region x {x0}–{x1}, y {y0}–{y1} pt',
  'appearance.pdfFidelity.row.transparency': '{count} × Transparent content',
  'appearance.pdfFidelity.row.transparencyRegion': '{count} × Transparent content — region x {x0}–{x1}, y {y0}–{y1} pt',
  'appearance.pdfFidelity.row.pattern': '{count} × Patterns and shadings',
  'appearance.pdfFidelity.row.patternRegion': '{count} × Patterns and shadings — region x {x0}–{x1}, y {y0}–{y1} pt',
  'appearance.pdfFidelity.row.dash': '{count} × Dashed strokes',
  'appearance.pdfFidelity.row.dashRegion': '{count} × Dashed strokes — region x {x0}–{x1}, y {y0}–{y1} pt',
  'appearance.pdfFidelity.row.roundCapJoin': '{count} × Round caps or joins',
  'appearance.pdfFidelity.row.roundCapJoinRegion': '{count} × Round caps or joins — region x {x0}–{x1}, y {y0}–{y1} pt',
  'appearance.pdfFidelity.row.curvedStroke': '{count} × Curved strokes',
  'appearance.pdfFidelity.row.curvedStrokeRegion': '{count} × Curved strokes — region x {x0}–{x1}, y {y0}–{y1} pt',
  'appearance.pdfFidelity.row.hairline': '{count} × Hairline strokes',
  'appearance.pdfFidelity.row.hairlineRegion': '{count} × Hairline strokes — region x {x0}–{x1}, y {y0}–{y1} pt',
  'appearance.pdfFidelity.row.hidden': '{count} × Hidden optional content',
  'appearance.pdfFidelity.row.hiddenRegion': '{count} × Hidden optional content — region x {x0}–{x1}, y {y0}–{y1} pt',
  'appearance.pdfFidelity.row.annotation': '{count} × Annotation appearances',
  'appearance.pdfFidelity.row.annotationRegion': '{count} × Annotation appearances — region x {x0}–{x1}, y {y0}–{y1} pt',
  'appearance.pdfFidelity.row.unsupported': '{count} × Unsupported operator {operator}',
