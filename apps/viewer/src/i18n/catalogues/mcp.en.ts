...
export const mcpEn = {
  ...
  'mcp.mcpLanding.statTypedTools': 'typed tools',
  'mcp.mcpLanding.statCategories': 'categories',
  'mcp.mcpLanding.statMcpClients': 'MCP clients',
  'mcp.mcpLanding.statTransports': 'transports',
