...
export const zonesPanelEn = {
  ...
  'zonesPanel.zoneRow.exportGeometryTitle': "Export this zone's geometry (straddlers cut at the boundary) as GLB",
  ...
  'zonesPanel.apportionSummary.splitVolumesButton': {
    one: 'Split volumes ({count} straddler)',
    other: 'Split volumes ({count} straddlers)',
  },
  ...
  'zonesPanel.writeBack.emitZonesLabel': 'Emit zones as IfcSpatialZone',
  ...
  'zonesPanel.roomPanel.removeFromRoomTooltip': 'Remove from room',
  'zonesPanel.roomPanel.emptyTitle': 'Work on this model together',
  'zonesPanel.roomPanel.emptyDescription': 'Create a room to edit live with others: shared cursors, presence, and every edit synced. Invites are one link.',
  'zonesPanel.roomPanel.createRoomButton': 'Create a room',
  'zonesPanel.roomPanel.inviteHint': "Got an invite? Just open the link - it lands you in the room.",
  'zonesPanel.roomPanel.rootAriaLabel': 'Collaboration room',
  'zonesPanel.roomPanel.uploadingModel': 'Uploading model',
  'zonesPanel.roomPanel.statusRoom': '{status} room',
