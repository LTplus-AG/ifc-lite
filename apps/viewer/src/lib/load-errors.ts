 ...
 *
 * This module maps such failures to a stable `kind` for analytics grouping;
 * `formatLoadError` in ./load-error-message.ts turns that kind into the
 * human-readable message (the toast / model loadError).
 */
