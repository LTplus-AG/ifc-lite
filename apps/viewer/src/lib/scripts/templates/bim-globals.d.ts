...
declare const bim: {
  ...
  structural: {
    ...
    activities(modelId?: string): Array<{ GlobalId: string; ExpressId: number; Type: string; Kind: 'Action' | 'Reaction' | 'Unknown'; Name?: string; Description?: string; ObjectType?: string; PredefinedType?: string; GlobalOrLocal?: string; DestabilizingLoad?: boolean; AppliesToGlobalId?: string; GroupGlobalIds: string[]; AppliedLoad?: { ExpressId: number; Type: string; Name?: string; Components: Record<string, number>; Configuration?: { Entries: Array<{ Value?: unknown; Dropped?: string; Location?: number[] }>; Locations?: number[][]; Truncated: boolean } } }>;
