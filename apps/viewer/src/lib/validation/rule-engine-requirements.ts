...
import {
  ...
  type TypeNameRule,
  type ValueOp,
} from '../search/filter-rules.js';
import type { FilterGroup } from '../search/filter-groups.js';
import type { FilteredElement } from '../search/filter-evaluate.js';
import { readSubject, type ReadSubjectContext, type SubjectValue } from '../search/read-subject.js';
import {
  matchStringAnyNone,
  numericOpMatches,
  setOpMatches,
  ...
  valueOpMatches,
  type OpMatchOptions,
} from '../search/filter-ops.js';
import type { RuleBlock } from './rule-set.js';
