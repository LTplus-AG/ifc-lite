...
import { compileZone, zoneOverlapsAABBCompiled, type CompiledZone } from './geometry.js';
...
function piecesAabb(pieces: readonly ElementMeshPiece[]): [number, number, number, number, number, number] | null {
