...
const PINNED_SESSION_RESET_KEYS: readonly string[] = [
  ...
  'interactionMode', 'isolatedEntities', 'isolatedEntitiesByModel', 'lensAppliedHiddenIds', 'lensColorMap',
...
const PINNED_OWNED_KEYS: readonly string[] = [
  ...
  'ifcDataStore', 'interactionMode', 'isolatedEntities', 'isolatedEntitiesByModel', 'lensAppliedHiddenIds',
