...
class ControlledWorker implements AppearanceWorker {
  ...
  postMessage(message: AppearanceWorkerRequest) {
    ...
    if (message.type === 'pdf-fidelity' || message.type === 'pdf-fill-plan' || message.type === 'mesh-transfer' || message.type === 'scan-registration' || message.type === 'page-plan' || message.type === 'annotation-plan' || message.type === 'captured-mesh-plan') throw new Error('Image-only controller fixture received a page plan');
