...
5. Export **IFC + images** through the normal export dialog. The packaged PNG is
...
6. Reopen the IFCZIP in a fresh browser and click the member in the actual
...
[History observations](viewer-history.json) record the model and Scene inventory
