...
side of a thin wall, or objects beyond it, from painting the near face; raise it
only to the accepted registration error plus modelling tolerance. Increasing atlas density can improve visible
