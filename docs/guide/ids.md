...
| List, enumerated and table values | Covered: a property rule matches ANY member / cell (IDS parity); a negated op (`ne`, `notContains`, `notMatches`) holds only when NO member has the value (#5475) |
