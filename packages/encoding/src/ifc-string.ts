 ...
 * literal-context contract: doubling `'` and `\`, and encoding control
 * characters and non-ASCII as directives —
 ...
 * C0 controls AND on DEL (U+007F) -- `\X2\00HH\X0\` there, `\X\HH` here --
 * and on all
