...
export interface InitOutput {
  ...
  readonly __wasm_bindgen_func_elem_1099: (a: number, b: number, c: number) => void;
  readonly __wasm_bindgen_func_elem_1098: (a: number, b: number) => void;
  readonly __wasm_bindgen_func_elem_1370: (a: number, b: number, c: number, d: number) => void;
