...
export interface InitOutput {
  ...
  readonly __wasm_bindgen_func_elem_1185: (a: number, b: number, c: number) => void;
  readonly __wasm_bindgen_func_elem_1184: (a: number, b: number) => void;
  readonly __wasm_bindgen_func_elem_1224: (a: number, b: number, c: number, d: number) => void;
