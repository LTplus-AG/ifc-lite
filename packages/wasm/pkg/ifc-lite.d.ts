...
export interface InitOutput {
  ...
  readonly __wasm_bindgen_func_elem_1180: (a: number, b: number, c: number) => void;
  readonly __wasm_bindgen_func_elem_1179: (a: number, b: number) => void;
  readonly __wasm_bindgen_func_elem_1219: (a: number, b: number, c: number, d: number) => void;
