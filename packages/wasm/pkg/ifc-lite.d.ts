...
export interface InitOutput {
  ...
  readonly __wasm_bindgen_func_elem_1217: (a: number, b: number, c: number) => void;
  readonly __wasm_bindgen_func_elem_1216: (a: number, b: number) => void;
  readonly __wasm_bindgen_func_elem_1257: (a: number, b: number, c: number, d: number) => void;
