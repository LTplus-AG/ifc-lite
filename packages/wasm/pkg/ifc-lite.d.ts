...
export interface InitOutput {
  ...
  readonly __wasm_bindgen_func_elem_1189: (a: number, b: number, c: number) => void;
  readonly __wasm_bindgen_func_elem_1188: (a: number, b: number) => void;
  readonly __wasm_bindgen_func_elem_1228: (a: number, b: number, c: number, d: number) => void;
