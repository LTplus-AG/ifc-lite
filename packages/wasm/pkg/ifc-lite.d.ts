...
export interface InitOutput {
  ...
  readonly __wasm_bindgen_func_elem_1210: (a: number, b: number, c: number) => void;
  readonly __wasm_bindgen_func_elem_1209: (a: number, b: number) => void;
  readonly __wasm_bindgen_func_elem_1250: (a: number, b: number, c: number, d: number) => void;
