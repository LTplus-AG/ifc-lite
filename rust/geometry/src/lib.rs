...
pub use router::{
    aggregate_diagnostics, ClassificationStats, ClassificationSummary, DefinitionCache,
    GeometryDiagnostics, GeometryProcessor, GeometryRouter, HostOpeningDiagnostic, ItemDedupCache,
    OpeningDiagnostic, OpeningKindDiag, ReasonCount, RectFastSummary, RectParam, WorstHost,
};
