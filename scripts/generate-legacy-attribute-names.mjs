...
//! reads, per #4203. Each row is an entity absent from the canonical IFC4X3
//! catalog (\`IfcType::ALL\`), paired with its OWN declared positional
//! attribute names (not a base-type approximation — see the generator's file
//! header for why that would mislabel values).
//!
