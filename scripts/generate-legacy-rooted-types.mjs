...
//! \`legacy_attribute_names.rs\` reads, per #4203. Each name is absent from
//! the canonical IFC4X3 catalog (\`IfcType::ALL\`) and has a parent chain
//! reaching \`IfcRoot\` in at least one of those tables.
//!
