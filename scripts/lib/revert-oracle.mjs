...
// `playwright.config.ts` is read by `playwright test` alone -- the same runner
// the oracle cannot drive for `tests/e2e/**` -- so a change to it is as
// unobservable here as the specs it configures (#5147).
